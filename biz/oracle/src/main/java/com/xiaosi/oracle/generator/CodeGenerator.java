...
public class CodeGenerator {
    ...
    public static void getCode() {
        String projectPath = System.getProperty("user.dir")+"\\biz\\oracle";
        ...
        List<String> tables = List.of("emp");//需要生成对应代码的表名的集合
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder ->
                        builder.parent("com.xiaosi.oracle")//TODO 修改为自己项目的路径
