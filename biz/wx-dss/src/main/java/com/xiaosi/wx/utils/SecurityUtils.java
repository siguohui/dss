...
public abstract class SecurityUtils {
     ...
     * @return
     */
    public final static Object getSession() {
        RequestAttributes requestAttributes = RequestContextHolder.getRequestAttributes();

        Object authorization = requestAttributes.getAttribute("Authorization", 0);
...
//                int index = uri.indexOf(";SESSIONID=") + ";SESSIONID=".length();
//                int length = "25C94CF4CF7F2550DA6815F5141B9360".length();
//                if (uri.length() >= index + length) {
//                    String jsid = uri.substring(index, index + length);
//                    session = SessionContext.getInstance().getSession(jsid);
//                }
//            }
//            // default
//            else {
